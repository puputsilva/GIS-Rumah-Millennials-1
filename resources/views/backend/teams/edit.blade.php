            ...
            <div class="card-body">
                <form method="POST" action="{{ route('team.update', $team->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group p-2">
                        ...
                        <input type="url" name="facebook" class="form-control" value="{{ $team->facebook }}" placeholder="Link Facebook">
                        @error('facebook')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group p-2">
                        <label>Twitter</label>
                        <input type="url" name="twitter" class="form-control" value="{{ $team->twitter }}" placeholder="Link Twitter">
                        @error('twitter')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group p-2">
                        ...
                        <input type="url" name="instagram" class="form-control" value="{{ $team->instagram }}" placeholder="Link Instagram">
                        @error('instagram')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group p-2">
                        ...
                        <input type="url" name="linkedin" class="form-control" value="{{ $team->linkedin }}" placeholder="Link Linkedin">
                        @error('linkedin')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
